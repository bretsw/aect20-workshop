---
title: "Part 1: Introduction to R - Demo Doc"
author: 
output: pdf_document
---
...
To get started, let's load the {tidytags} package. Click the green arrow at the top right of the "code chunk" below:
...
Perhaps you remember from looking the `starwars` data a moment ago that Luke Skywalker's heights is 172. What, then, can you conclude from the data you've just filtered?
